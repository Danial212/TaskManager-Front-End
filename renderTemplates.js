...
// export { render_mono_category, render_mono_calander_day, taskItemTemplate, taskItemTemplate_complete, renderCategories, taskForm, openNewCategory, openEditTask, openNewTask, closeModal, openModal }
...
//     }"
//       data-date="${dateStr}"
//       title="${isCurrentMonth ? 'Click to view, double-click to add task' : 'Click to view'}"
//     > 
